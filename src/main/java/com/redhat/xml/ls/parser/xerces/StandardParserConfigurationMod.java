 ...
 *
 * @version $Id: StandardParserConfiguration.java 805582 2009-08-18 21:13:20Z
 *          sandygao $
 */
public class StandardParserConfigurationMod extends DTDConfigurationMod {
  ...
  protected static final String ID_IDREF_CHECKING = Constants.XERCES_FEATURE_PREFIX
      + Constants.ID_IDREF_CHECKING_FEATURE;

  /** Feature identifier: whether to ignore unparsed entity errors */
  protected static final String UNPARSED_ENTITY_CHECKING = Constants.XERCES_FEATURE_PREFIX
      + Constants.UNPARSED_ENTITY_CHECKING_FEATURE;

  /** Feature identifier: whether to ignore identity constraint errors */
  protected static final String IDENTITY_CONSTRAINT_CHECKING = Constants.XERCES_FEATURE_PREFIX
  ...
  protected static final String ROOT_TYPE_DEF = Constants.XERCES_PROPERTY_PREFIX
      + Constants.ROOT_TYPE_DEFINITION_PROPERTY;

  /** Property identifier: root element declaration. */
  protected static final String ROOT_ELEMENT_DECL = Constants.XERCES_PROPERTY_PREFIX
  ...
  /** Default constructor. */
  public StandardParserConfigurationMod() {
    this(null, null, null);
  } // <init>()
   ...
   */
  public StandardParserConfigurationMod(SymbolTable symbolTable) {
   ...
   */
  public StandardParserConfigurationMod(SymbolTable symbolTable, XMLGrammarPool grammarPool) {
  ...
  public StandardParserConfigurationMod(SymbolTable symbolTable, XMLGrammarPool grammarPool,
    ...
    final String[] recognizedFeatures = { NORMALIZE_DATA, SCHEMA_ELEMENT_DEFAULT, SCHEMA_AUGMENT_PSVI,
        GENERATE_SYNTHETIC_ANNOTATIONS, VALIDATE_ANNOTATIONS, HONOUR_ALL_SCHEMALOCATIONS, NAMESPACE_GROWTH,
        TOLERATE_DUPLICATES,
