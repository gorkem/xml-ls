 ...
 */
public class DTDConfigurationMod extends BasicParserConfiguration implements XMLPullParserConfiguration {
   ...
   */
  public DTDConfigurationMod(SymbolTable symbolTable) {
   ...
   */
  public DTDConfigurationMod(SymbolTable symbolTable, XMLGrammarPool grammarPool) {
   ...
   */
  public DTDConfigurationMod(SymbolTable symbolTable, XMLGrammarPool grammarPool, XMLComponentManager parentSettings) {
    ...
    final String[] recognizedProperties = { ERROR_REPORTER, ENTITY_MANAGER, DOCUMENT_SCANNER, DTD_SCANNER,
        DTD_PROCESSOR, DTD_VALIDATOR, NAMESPACE_BINDER, XMLGRAMMAR_POOL, DATATYPE_VALIDATOR_FACTORY, VALIDATION_MANAGER,
        JAXP_SCHEMA_SOURCE, JAXP_SCHEMA_LANGUAGE, LOCALE };
  ...
  protected XMLDocumentScanner createDocumentScanner() {
    return new XMLDocumentScannerImplMod();
