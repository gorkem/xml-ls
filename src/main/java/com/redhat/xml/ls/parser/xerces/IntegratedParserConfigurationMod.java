...
public class IntegratedParserConfigurationMod extends StandardParserConfigurationMod {
    ...
    /** Default constructor. */
    public IntegratedParserConfigurationMod() {
        this(null, null, null);
    } // <init>()
     ...
     */
    public IntegratedParserConfigurationMod(SymbolTable symbolTable) {
     ...
     */
    public IntegratedParserConfigurationMod(SymbolTable symbolTable, XMLGrammarPool grammarPool) {
    ...
    public IntegratedParserConfigurationMod(SymbolTable symbolTable, XMLGrammarPool grammarPool,
        ...
        // create components
        fNonNSScanner = new XMLDocumentScannerImplMod();
