 ...
 * @author Eric Ye, IBM
 *
 * @version $Id: XMLDocumentScannerImpl.java 572055 2007-09-02 17:55:43Z
 *          mrglavas $
 */
public class XMLDocumentScannerImplMod extends XMLDocumentFragmentScannerImplMod {
    ...
    /** Default constructor. */
    public XMLDocumentScannerImplMod() {
    } // <init>()
                ...
                do {
                    ...
                    case SCANNER_STATE_DOCTYPE: {
                        ...
                        if (fDoctypeSystemId != null) {
                            ...
                            if (((fValidation || fLoadExternalDTD)
                                    && (fValidationManager == null || !fValidationManager.isCachedDTD()))) {
                                // This handles the case of a DOCTYPE that had neither an internal subset or an
                                // external subset.
                ...
                do {
                    ...
                    case SCANNER_STATE_DTD_INTERNAL_DECLS: {
                        ...
                        if (!moreToScan) {
                            ...
                            setScannerState(SCANNER_STATE_PROLOG);
                            setDispatcher(fPrologDispatcher);
                            fEntityManager.setEntityHandler(XMLDocumentScannerImplMod.this);
                            return true;
                        }
                        break;
                    }
