...
public class ParserTests {
  ...
  // XMLDocumentNode node = (XMLDocumentNoQde) runParser("test", "<project />");
  // assertNotNull(node);
  // assertEquals(XMLNode.DOCUMENT_NODE, node.nodeType);
  // assertNotNull(node.children);
  // assertEquals(1, node.children.length);
  ...
  // XMLNode node = runParser("test", "<project a1=\"world\" a2=\"world\"
  // a3=\"!\"></project>");
  // assertNotNull(node);
  // assertEquals(XMLNode.DOCUMENT_NODE, node.nodeType);
  // assertNotNull(node.children);
